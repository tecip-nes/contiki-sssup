...
#define COAP_MAX_OBSERVERS      1 //COAP_MAX_OPEN_TRANSACTIONS-2
#endif

#ifndef COAP_MAX_OBSERVEES
#define COAP_MAX_OBSERVEES      1 // COAP_MAX_OPEN_TRANSACTIONS-2
#endif
...
#undef MAX_REACTIVE_REQUESTS
#define MAX_REACTIVE_REQUESTS 1
